  ...
  const testimonials = [
    {
      ...
      text: "Vision Guard's proactive threat detection has reduced our incident response time by 75% while maintaining 99.8% accuracy in identifying real threats.",
      rating: 5
    },
    {
      name: "Sarah Chen",
