...
const SecurityFAQ = () => {
  ...
  const faqs = [
    {
      question: "How does Vision Guard's AI detect threats in real-time?",
    ...
    },
    {
      ...
      answer: "Vision Guard supports 1500+ devices via RTSP/ONVIF with auto-discovery. Our zero-trust pairing ensures encrypted feeds without exposing your network.",
